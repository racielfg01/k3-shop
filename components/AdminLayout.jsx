...
import { BarraLateral, Dashboard, Footer } from "./adminComponents/";
      ...
      <div>
        ...
        <div className="flex overflow-hidden  pt-16">
          <div
            ...
            id="sidebarBackdrop"
          ></div>
          <div className="ml-72 sm:ml-6 md:ml-6  min-h-screen ">{children}</div>
        </div>
      </div>
    </main>
  );
...
// <div className="h-screen bg-theme p-10 grid grid-cols-4 grid-rows-4 gap-6">
...
//  <BarraLateral/>
// <div className="grid col-span-4 row-span-4">
//   {children}
// </div>
...
{
  /* <div className="min-h-screen bg-theme relative overflow-y-auto">
<Navbar />
<Cart />
<div  className="my-28">
