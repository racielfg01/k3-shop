import NavbarCuenta from "../NavbarCuenta"
    ...
    <div className="px-3 py-3 lg:px-5 lg:pl-3">
       <div className="flex items-center justify-between">
          <div className="flex items-center justify-start">
             ...
             className="hidden sm:block md:block mr-2 text-gray-600 hover:text-gray-900 cursor-pointer p-2
              hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 rounded">
                <svg id="toggleSidebarMobileHamburger" className="w-6 h-6" 
                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                   <path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 
                   1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
                    clip-rule="evenodd"></path>
                </svg>
                <svg id="toggleSidebarMobileClose" 
                className="w-6 h-6 hidden" fill="currentColor" 
          ...
          <div className="flex items-center">
            ...
            <form action="#" method="GET" 
             className="sm:hidden md:hidden lg:block lg:pl-32 md:pl-32 pr-6">
             ...
             className="hidden sm:block md:block text-gray-500 hover:text-gray-900 hover:bg-gray-100 p-2 rounded-lg">
