...
const data = {
  ...
  return (
   //  <div className="flex flex-col absolute overflow-y-auto w-auto">
       <div className="gap-4 flex justify-center bg-gray-200 min-h-screen flex-col absolute overflow-y-auto w-auto">
  
             <div className=" grid grid-cols-2 sm:grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                ...
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                   <div className="mb-4 flex items-center justify-between">
                      <div>
                         <h3 className="text-xl font-bold text-gray-900 mb-2">Últimas transaciones</h3>
                         <span className="text-base font-normal text-gray-500">Esta es la listas de las últimas transaciones</span>
                      </div>
                      <div className="flex-shrink-0">
             ...
             <div className="mt-4 w-full grid grid-cols-3 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                ...
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 gap-4">
                   <div className="flex items-center">
                      <div className="flex-shrink-0">
