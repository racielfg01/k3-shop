...
const BarraLateral = () => {
  ...
  return (
    <aside id="sidebar" 
    className="fixed z-20 h-full top-0 left-0 pt-16 flex lg:flex md:hidden
    flex-shrink-0 flex-col w-64 transition-width duration-75 " aria-label="Sidebar">
       <div className="relative flex min-h-0 border-r border-gray-200 rounded-r-lg bg-white pt-0">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
             <div className="flex-1 px-3 bg-white divide-y space-y-1">
                <ul className="space-y-2 pb-2">
                   <li>
                      <form action="#" method="GET" className="hidden sm:block md:block">
                   ...
                   <li>
                    <Link href={'/dashboard'} >
                      <div  className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                         ...
                         <span className="ml-3">Pizarra</span>
                      </div>
                      </Link>
                   </li>
                   <li>
                   <Link href={'/tienda'} >
                   <div  target="_blank" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                   ...
                   <li>
                    ...
                    <li>
                      <a href="#" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                         ...
                         <span className="ml-3 flex-1 whitespace-nowrap">Servicios</span>
                      </a>
                   </li>
                   <li>
                      <a href="#" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                ...
                <div className="space-y-2 pt-2">
                   ...
                   <a href="#" target="_blank" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                      ...
                      <span className="ml-3">Ayuda y Soporte</span>
                   </a>
                </div>
             </div>
          </div>
