...
const sortOptions = [
  ...
  { name: 'Mejores Calificados', href: '#', current: false },
  { name: 'Nuevos', href: '#', current: false },
  { name: 'Precio: Bajo a Alto', href: '#', current: false },
  { name: 'Price: Alto a Bajo', href: '#', current: false },
]
const subCategories = [
  { name: 'Ropas', href: '#' },
  { name: 'Alimentos', href: '#' },
  ...
  useEffect(() => {
    const getArticulos = async () => {
      ...
      try {
        ...
        // console.log("🚀 ~ file: index.tsx:78 ~ getArticulos ~ articulos", articulos)
    ...
    <Layout>
      ...
      <div>
        ...
        <Transition.Root show={mobileFiltersOpen} as={Fragment}>
          ...
          <div className="bg-theme h-16"></div>
        <main className="max-w-7xl px-4 sm:px-6 lg:px-8 mx-5">
          <div className="flex items-baseline justify-end border-b border-gray-200 pt-2 pb-6 ">
            ...
            <div className="flex  items-center">
              ...
              <button
                type="button"
                className="-m-2 ml-4 p-2 text-gray-400 hover:text-gray-500 sm:ml-6 hidden lg:block "
            ...
            <div className="grid grid-cols-6 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="col-span-5">
                {/* Replace with your content */}
                  <Ventas productos={productos} ifExists={false} 
                  // endpoint={topratesales}
                  />
                {/* <div className="h-96 rounded-lg border-4 border-dashed border-gray-200 lg:h-full col-auto" /> */}
...
//   console.log("🚀 ~ file: index.tsx:331 ~ getStaticProps ~ articulos", articulos)
